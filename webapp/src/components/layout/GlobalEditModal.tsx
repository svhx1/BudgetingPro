                                                ...
                                                {amount && Number(amount) > 0 && (
                                                    <p className="text-[11px] text-(--color-text-muted) text-center mt-2 bg-(--color-text-main)/5 py-1.5 px-2 rounded-md font-medium">
                                                        {installmentMode === "TOTAL"
                                                            ? `Entrará como gasto ÚNICO de ${((Number(amount) / 100)).toLocaleString("pt-BR", { style: "currency", currency: "BRL" })} na data selecionada (com selo de ${installments}x).`
                                                            : `Entrará como gasto ÚNICO de R$ ${((Number(amount) / 100) * installments).toLocaleString("pt-BR", { minimumFractionDigits: 2 })} na data selecionada (com selo de ${installments}x).`
                                                        }
                                                    </p>
                                                )}
                                            </div>
