        ...
        <div className="flex flex-col min-h-screen w-full pb-10">
            ...
            {loading ? (
                ...
                <motion.div
                    ...
                    className="glass-panel p-10 md:p-16 rounded-3xl flex flex-col items-center justify-center text-center border-dashed border-2 border-white/10"
                >
                    <div className="p-6 bg-white/5 rounded-2xl mb-6">
                        <Target className="w-16 h-16 text-(--color-text-muted)" />
                    </div>

                    <h2 className="text-2xl font-bold text-white mb-3">Nenhuma meta ainda</h2>
